...
namespace PromoItServer.MicroServies
{
    public static class MicroService
    {
        [FunctionName("MicroService")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", "post", "delete", Route = "service/{action}/{IdNumber?}")] HttpRequest req,
            string action, string IdNumber, ILogger log)
        {
            ...
            {
                case "get-role":
                    var rolesURL = $"https://dev-71vlxms0epcj8hhj.us.auth0.com/api/v2/users/{IdNumber}/roles";
                ...
                case "get-pendding":
                    string responseMessage = System.Text.Json.JsonSerializer.Serialize(MainManager.Instance.RegisterApplicationsM.getPenddingFromDB(IdNumber));
